      ...
      <main>
        ...
        <section className="relative min-h-[70vh] flex items-center justify-center px-6 pt-20">
          ...
          <div className="container-narrow text-center relative z-10">
            <MotionSection>
              <Link to="/enterprise" className="inline-flex items-center gap-2 text-muted-foreground hover:text-foreground transition-colors mb-8">
            ...
            <MotionSection delay={300}>
              <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                <Link to="/enterprise/dealflow/live">
        ...
        <section className="section">
          <div className="container-narrow">
            ...
            <MotionSection delay={100}>
              <h2 className="headline-lg text-foreground mb-6">{r.problemTitle}</h2>
            </MotionSection>
            <MotionSection delay={200}>
              <p className="body-md max-w-2xl mb-8">{r.problemBody}</p>
            </MotionSection>
            <MotionSection delay={300}>
        ...
        <section className="section">
          <div className="container-narrow">
            ...
            <MotionSection delay={100}>
              <h2 className="headline-lg text-foreground mb-6">{r.solutionTitle}</h2>
            </MotionSection>
            <MotionSection delay={200}>
              <p className="body-md max-w-2xl mb-2">{r.solutionBody1}</p>
        ...
        <section className="section">
          <div className="container-narrow">
            ...
            <MotionSection delay={100}>
              <h2 className="headline-lg text-foreground mb-10">{r.processTitle}</h2>
            </MotionSection>
        ...
        <section className="section">
          <div className="container-narrow">
            ...
            <MotionSection delay={100}>
              <h2 className="headline-lg text-foreground mb-8">{r.backendTitle}</h2>
            </MotionSection>
            <MotionSection delay={200}>
              <div className="glass-card p-8 max-w-2xl">
                <ul className="space-y-4">
        ...
        <section className="section">
          <div className="container-narrow">
            ...
            <MotionSection delay={100}>
              <h2 className="headline-lg text-foreground mb-8">{r.resultTitle}</h2>
            </MotionSection>
