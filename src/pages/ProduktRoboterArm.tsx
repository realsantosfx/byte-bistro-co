          ...
          <div className="relative overflow-hidden rounded-[18px] aspect-[16/9] bg-[#0a0f18]">
            ...
            <div className="absolute bottom-6 left-6 right-6 md:bottom-8 md:left-8 md:right-8 flex flex-wrap items-end justify-between gap-4">
              <div className="max-w-[520px]">
                <div className="text-[10.5px] font-semibold uppercase tracking-[0.16em] text-white/50 mb-2">Live — Pick-and-Place an der Linie</div>
                <h3 className="display text-[22px] md:text-[28px] font-bold text-white leading-tight">6-Achs-Arm im Produktionstakt</h3>
              </div>
              <div className="flex flex-wrap gap-2">
                {["6 Achsen", "Vision", "QS", "ERP/MES"].map((b) => (
