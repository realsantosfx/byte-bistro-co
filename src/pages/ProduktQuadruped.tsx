...
import patrolVideo from "@/assets/site/robot-quadruped-patrol.mp4.asset.json";
      ...
      <main>
        ...
        <section className="pb-20 md:pb-24 section-x container-shell">
          <div className="relative overflow-hidden rounded-[18px] aspect-[16/9] bg-[#0a0f18]">
            <video src={patrolVideo.url} autoPlay muted loop playsInline preload="auto" poster={heroImg} className="absolute inset-0 w-full h-full object-cover" />
            ...
            <div className="absolute bottom-6 left-6 right-6 md:bottom-8 md:left-8 md:right-8 flex flex-wrap items-end justify-between gap-4">
              <div className="max-w-[520px]">
                <div className="text-[10.5px] font-semibold uppercase tracking-[0.16em] text-white/50 mb-2">Live — Inspektion auf Treppen & Schächten</div>
                <h3 className="display text-[22px] md:text-[28px] font-bold text-white leading-tight">Vierbein im Außenbereich</h3>
              </div>
              <div className="flex flex-wrap gap-2">
                {["Treppen", "Schotter", "Wärmebild", "Anomalie"].map((b) => (
