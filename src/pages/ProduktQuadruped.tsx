...
import patrolImg from "@/assets/site/robot-quadruped-patrol.jpg";
      ...
      <main>
        ...
        <section className="pb-20 md:pb-24 section-x container-shell">
          <div className="relative overflow-hidden rounded-[18px] aspect-[16/9] bg-[#0a0f18]">
            <img src={patrolImg} alt="Quadruped-Roboter im Lager" loading="lazy" width={1920} height={1080} className="absolute inset-0 w-full h-full object-cover" />
